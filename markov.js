...
var Markov = function(file) { if (file) this.setSourceFile(file); return this; };
var proto = Markov.prototype

proto.setSourceString = function(str) { this.text = str };
proto.source = function(str) { return this.text };
proto.setSourceString = function(str) { this.text = str; return this; };

// new Markov().setSourceString('hello Markov').source() === 'hello Markov';

proto.setSourceFile = function(file, encoding) { this.text = fs.readFileSync(file, encoding || 'utf-8'); return this; }

// typeof new Markov().setSourceFile(__dirname + '/markov.js').source() === 'string';

/* Strip HTML tags */
function strip_tags(inp) { return inp.replace(/<[^>]*?>/g, ' '); }
